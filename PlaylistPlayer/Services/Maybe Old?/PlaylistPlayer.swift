...
//    func playPrevious() {
//
//        // Since `WrappedAVQueuePlayer` doesn't support skipping to the previous item (because items are removed once they're played) we have to rebuild the queue every time the user plays previous.
//
//        defer {
//            requeueIfNeeded()
//        }
